...
export const GridSetupPanel = ({
  ...
  return (
    <div className="bg-[#1a1a1e] border border-zinc-800 rounded-xl p-5 shadow-xl">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="flex flex-col gap-1.5">
          ...
          <input
            ...
            min="1"
            max="12"
            className="bg-zinc-800 border border-zinc-700 text-white px-3 py-1.5 text-sm rounded focus:outline-none focus:border-purple-500"
            value={numCols}
            onChange={e => setNumCols(parseInt(e.target.value) || 1)}
          />
        </div>
        <div className="flex flex-col gap-1.5">
          <label className="text-xs text-zinc-400">Column Gap (px)</label>
          <input
            type="number"
            min="0"
            className="bg-zinc-800 border border-zinc-700 text-white px-3 py-1.5 text-sm rounded focus:outline-none focus:border-purple-500"
        ...
        <div className="flex flex-col gap-1.5">
          <label className="text-xs text-zinc-400">Row Gap (px)</label>
          <input
            type="number"
            min="0"
            className="bg-zinc-800 border border-zinc-700 text-white px-3 py-1.5 text-sm rounded focus:outline-none focus:border-purple-500"
